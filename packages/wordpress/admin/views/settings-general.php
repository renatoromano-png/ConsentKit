...
<table class="form-table" role="presentation">
	<tr>
		...
		<td>
			<label>
				<input type="checkbox" id="ck-show-banner" name="<?php echo esc_attr( $opt ); ?>[show_banner]" value="1" <?php checked( $settings['show_banner'], 1 ); ?> />
	...
	<tr>
		...
		<td><input type="text" id="ck-title" class="regular-text" name="<?php echo esc_attr( $opt ); ?>[title]" value="<?php echo esc_attr( $settings['title'] ); ?>" /></td>
	</tr>
	<tr>
		<th scope="row"><label for="ck-body"><?php esc_html_e( 'Testo banner', 'consentkit' ); ?></label></th>
		<td>
			<textarea id="ck-body" class="large-text" rows="3" name="<?php echo esc_attr( $opt ); ?>[body]"><?php echo esc_textarea( $settings['body'] ); ?></textarea>
	...
	<tr>
		...
		<td>
			<p>
				...
				<input type="text" name="<?php echo esc_attr( $opt ); ?>[accept_label]" value="<?php echo esc_attr( $settings['accept_label'] ); ?>" /></label>
			</p>
			<p>
				<label><?php esc_html_e( 'Rifiuta', 'consentkit' ); ?><br>
				<input type="text" name="<?php echo esc_attr( $opt ); ?>[reject_label]" value="<?php echo esc_attr( $settings['reject_label'] ); ?>" /></label>
			</p>
			<p>
				<label><?php esc_html_e( 'Gestisci preferenze', 'consentkit' ); ?><br>
				<input type="text" name="<?php echo esc_attr( $opt ); ?>[customize_label]" value="<?php echo esc_attr( $settings['customize_label'] ); ?>" /></label>
			</p>
			<p>
				<label><?php esc_html_e( 'Rivedi le scelte (footer/icona)', 'consentkit' ); ?><br>
				<input type="text" name="<?php echo esc_attr( $opt ); ?>[review_label]" value="<?php echo esc_attr( $settings['review_label'] ); ?>" /></label>
			</p>
	...
	<tr>
		...
		<td><input type="text" id="ck-color" class="ck-color-field" name="<?php echo esc_attr( $opt ); ?>[primary_color]" value="<?php echo esc_attr( $settings['primary_color'] ); ?>" /></td>
	</tr>
	<tr>
		<th scope="row"><label for="ck-position"><?php esc_html_e( 'Posizione banner', 'consentkit' ); ?></label></th>
		<td>
			<select id="ck-position" name="<?php echo esc_attr( $opt ); ?>[position]">
	...
	<tr>
		...
		<td><input type="number" id="ck-duration" min="1" name="<?php echo esc_attr( $opt ); ?>[consent_duration]" value="<?php echo esc_attr( $settings['consent_duration'] ); ?>" /></td>
	</tr>
	<tr>
		<th scope="row"><label for="ck-reprompt"><?php esc_html_e( 'Min. giorni prima di riproporre', 'consentkit' ); ?></label></th>
		<td>
			<input type="number" id="ck-reprompt" min="180" name="<?php echo esc_attr( $opt ); ?>[reprompt_after_days]" value="<?php echo esc_attr( $settings['reprompt_after_days'] ); ?>" />
	...
	<tr>
		...
		<td>
			<input type="text" id="ck-policy-version" name="<?php echo esc_attr( $opt ); ?>[policy_version]" value="<?php echo esc_attr( $settings['policy_version'] ); ?>" />
	...
	<tr>
		...
		<td><input type="date" id="ck-force-renew" name="<?php echo esc_attr( $opt ); ?>[force_renew_date]" value="<?php echo esc_attr( $settings['force_renew_date'] ); ?>" /></td>
	</tr>
	<tr>
		<th scope="row"><label for="ck-privacy-url"><?php esc_html_e( 'URL privacy policy', 'consentkit' ); ?></label></th>
		<td><input type="url" id="ck-privacy-url" class="regular-text" name="<?php echo esc_attr( $opt ); ?>[privacy_policy_url]" value="<?php echo esc_attr( $settings['privacy_policy_url'] ); ?>" /></td>
	</tr>
	<tr>
		<th scope="row"><label for="ck-cookie-url"><?php esc_html_e( 'URL cookie policy', 'consentkit' ); ?></label></th>
		<td><input type="url" id="ck-cookie-url" class="regular-text" name="<?php echo esc_attr( $opt ); ?>[cookie_policy_url]" value="<?php echo esc_attr( $settings['cookie_policy_url'] ); ?>" /></td>
	</tr>
</table>
